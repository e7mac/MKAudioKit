...
#define ABSDKVersionString @"2.1.3"
...
@section Create-Ports 8. Create Ports
 ...
 <blockquote class="alert" id="unique-acd">
 It's very important that you use a unique AudioComponentDescription for each port. These AudioComponentDescriptions also
 must be unique among all apps. If you don't have a globally unique AudioComponentDescription for each port, you'll get 
 all sorts of Inter-App Audio errors (like error -66750 or -10879).  
