 ...
 */
- (void)registerNewFrame:(UIImage*)frame withIdentifier:(NSInteger)identifier;
 ...
 */
- (UIImage*)frameForIdentifier:(NSInteger)identifier;
 ...
 */
@property (nonatomic, assign) NSInteger currentFrameIdentifier;
